...
namespace Webkho_20241021.Controllers.Base
{
    /// <summary>
    /// Base controller cho ThongtincanhanController - dùng chung cho tất cả Areas
    /// Các Areas chỉ cần kế thừa từ class này và thêm [Area] và [Authorize(Roles)] attributes
    /// </summary>
    [Authorize]
    public abstract class BaseThongtincanhanController : Controller
    {
        protected readonly ApplicationDbContext _context;
        
        protected BaseThongtincanhanController(ApplicationDbContext context)
        {
            _context = context;
        }
