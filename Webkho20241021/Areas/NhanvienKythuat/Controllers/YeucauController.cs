...
namespace Webkho_20241021.Areas.NhanvienKythuat.Controllers
{
    ...
    public class YeucauController : Controller
    {
        ...
        public IActionResult Yeucau(string search = "")
        {
            ...
            var VTyeucaulist = _context.vtyeucau.ToList(); // Giữ cả dòng SLMoi = 0 để không mất trạng thái nhập/xuất
            ...
            if (isNhapKhoRequest)
            {
                ...
                var vatTuList = (from vtnk in _context.vtphieunhapkho
                                ...
                                select new
                                {
                                    ...
                                    HangSX = vtnk.HangSX,
                                    NhaCC = vtnk.NhaCC,
                                    // Đồng bộ với cấu trúc trả về bên Trưởng BP để hiển thị đúng cột SL Mới
                                    SLCu = (int?)null,
                                    SLMoi = vtnk.SL,
                                    SL = vtnk.SL,
                                    DonVi = vtnk.DonVi,
