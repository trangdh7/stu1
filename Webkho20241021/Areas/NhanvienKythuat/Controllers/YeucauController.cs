...
namespace Webkho_20241021.Areas.NhanvienKythuat.Controllers
{
    ...
    public class YeucauController : Controller
    {
        ...
        /// <summary>
        /// Xóa yêu cầu khi nhân viên là người tạo và Trưởng BP chưa duyệt.
        /// </summary>
        [HttpPost]
        ...
        public IActionResult ExportYeucauVatTuExcel(string MaYeucau)
        {
            ...
            using (var package = new ExcelPackage())
            {
                ...
                // Hàng 2: (trống 1-5) | Cũ, Mới, Thiếu, Đã xuất, Tồn kho | (trống 11-16)
                ...
                // Gộp dọc cho cột 1-5 và 11-16 (span 2 hàng)
