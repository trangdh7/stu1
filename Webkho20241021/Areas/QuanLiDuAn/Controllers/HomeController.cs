...
namespace Webkho_20241021.Areas.QuanLiDuAn.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult ThemvattuSQL(string[] TenSanpham, string[] MaSanpham, string[] HangSX, string[] NhaCC, int[] SL, string[] DonVi, DateTime?[] NgayBaohanh, DateTime?[] ThoiGianBH)
        {
            ...
            return RedirectToAction("Tongkho", "Home", new { area = "QuanLiDuAn" });
        }
        ...
        public IActionResult KhoDuAn(int page = 1, int pageSize = 20, string q = null, string duAn = null)
        {
            ...
            // Lấy vật tư từ phiếu xuất kho dự án của cá nhân
            ...
            var dataList = (from vtx in _context.vtphieuxuatkho
                           ...
                           // Left join với vtphieunhapkho để lấy thông tin mới nhất (Makho, Hãng SX, NhaCC)
