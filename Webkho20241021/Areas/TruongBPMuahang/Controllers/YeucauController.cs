...
namespace Webkho_20241021.Areas.TruongBPMuahang.Controllers
{
    ...
    public class YeucauController : Controller
    {
        ...
        public IActionResult GetDulieuThongbao()
        {
            ...
            {
                // Đếm phiếu mua hàng có trạng thái "Đang chờ báo giá" (cần báo giá) hoặc "Đã thanh toán" (cần xác nhận nhận hàng)
                thongbaomuahangcount = _context.phieumuahang.Count(p => p.TrangThai == "Đang chờ báo giá" || p.TrangThai == "Đã thanh toán");
            }
        ...
        public IActionResult ThemPhieunhapkhoSQL(phieunhapkho phieunhapkho, vtphieunhapkho vtphieunhapkho, string[] TenSanpham, string[] MaSanpham, string[] HangSX, string[] NhaCC, int[] SL, string[] DonVi, string[] Makho)
        {
            ...
            if (existingPhieunhapkho != null)
            {
                ...
                return RedirectToAction("ThemPhieunhapkho", "Yeucau", new { area = "TruongBPMuahang" });
            }
